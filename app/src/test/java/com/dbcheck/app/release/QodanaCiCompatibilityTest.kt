...
class QodanaCiCompatibilityTest {
    ...
    fun qodanaWorkflowMakesNonBlockingAgpRiskVisible() {
        ...
        listOf(
            "name: Qodana Analysis (non-blocking AGP 9.1 risk)",
            "JetBrains/qodana-action@107939d10e5ddbffb88bc5dd279934314937ed7a",
            "continue-on-error: true",
            "QODANA_TOKEN: \${{ secrets.QODANA_TOKEN }}",
            "Record Qodana compatibility risk",
            "GITHUB_STEP_SUMMARY",
            "ei-blokkaava AGP 9.1.0 -yhteensopivuusriski",
    ...
    private companion object {
        val expectedQaMarkers = listOf(
            ...
            "CI Qodana run: NOT RUN",
            "Do not remove continue-on-error",
            "Qodana Analysis (non-blocking AGP 9.1 risk)",
            "GITHUB_STEP_SUMMARY",
            "CI-status",
            "Release risk",
